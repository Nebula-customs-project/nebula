...
export default function VehicleMap({ location, vehicleName }) {
    ...
    `;
        ...
        if (markerRef.current) {
            ...
            markerRef.current = L.marker([lat, lng], { icon: carIcon }).addTo(mapRef.current);
        }
    ...
    return (
        <div className="relative w-full h-full rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
            ...
            <div className="absolute bottom-4 left-4 z-[400] bg-black/80 backdrop-blur px-3 py-1.5 rounded-lg border border-white/10 text-xs text-gray-400">
